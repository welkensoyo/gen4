%rebase('templates/render/datatables.tpl', title='Azure To Paylocity')
%columns = 'Company ID', 'Employee ID', 'User Type',  'Work Email'
<div class="container">
    <h5 class="text-muted">Paylocity Import</h5>
